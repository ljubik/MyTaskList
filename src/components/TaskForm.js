...
class TaskForm extends React.Component {
  ...
  async componentDidMount() {
    ...
    console.log("Start data", typeof taskList);
  ...
  handleSubTaskSubmit(data) {
    ...
    const { taskId, subName, isChecked = "false" } = data; //отримуємо дані з суб таску
  ...
  checkboxChange(sub, taskIndex, subTaskIndex, isChecked) {
